                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="cardholder-name" required type="text"
                                                               placeholder="{{trans('lang.cardholder_name')}}" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="address_line1" id="address_line1" required
                                                               type="text" placeholder="{{trans('lang.address')}}" class="form-control"
                                                               value=""/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="state" id="state" required type="text"
                                                               placeholder="{{trans('lang.state')}}" class="form-control" value=""/>
                                                    </div>
                                                </div>
