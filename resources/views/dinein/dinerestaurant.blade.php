            ...
            <div class="error" id="field_error1" style="color:red;display:none;"></div>
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        ...
                        <p>{{trans('lang.selected_day_of_the_week')}}: <span id="dayOfWeek"></span></p>
                ...
                <form>
                    ...
                    <div class="recepie-body">
                        ...
                        <div class="custom-control custom-radio border-bottom py-2">
                            ...
                            <label class="custom-control-label" for="customRadio5f">{{trans('lang.vegetables')}} <span class="text-muted">+$5.00</span></label>
                        ...
                        <div class="custom-control custom-radio border-bottom py-2">
                            ...
                            <label class="custom-control-label" for="customRadio6f">{{trans('lang.noodles')}} <span class="text-muted">+$30.00</span></label>
...
<script type="text/javascript">
        ...
        vendorDetailsRef.get().then(async function (vendorSnapshots) {
            ...
            var specialOfferForHour = [];
             ...
             if (vendorDetails.hasOwnProperty("restaurantCost")) {
                    ...
                    $("#cost_for_two").append("{{trans('lang.approx_cost_is_not_added')}}");
    ...
    $(".book_table_btn").click(async function () {
        ...
        if(totalGuest==""){
            ...
            $("#field_error1").html("");
            jQuery("#field_error1").html("{{trans('lang.please_select_people')}}"); 
        }
        else if(time==""){
            $("#field_error1").css('display','block');
            $("#field_error1").html("");
            jQuery("#field_error1").html("{{trans('lang.please_select_time')}}"); 
        }
