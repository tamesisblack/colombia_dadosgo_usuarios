<nav id="main-nav">
    <ul class="second-nav">
        <li> <a href="{{url('search')}}" class="widget-header mr-4 page text-dark">
        ...
        @auth
            <li><a href="{{url('offers')}}" class="widget-header mr-4 page text-dark offer-link">
                            <div class="icon d-flex align-items-center">
                        ...
                        <li> <a href="{{url('/checkout')}}" class="widget-header mr-4 page text-dark">
                            <div class="icon d-flex align-items-center">
            ...
            <li class="cashback-menu d-none"><a href="{{ url('cashback') }}"><i class="feather-dollar-sign mr-2"></i> {{ trans('lang.cashback_offers') }}</a>
            </li>
            ...
            <li><a href="{{ url('contact-us') }}"><i class="feather-phone mr-2"></i>{{ trans('lang.contact_us') }}</a></li>
            <li><a href="{{ url('logout') }}" onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();"><i class="feather-log-out mr-2"></i>{{ trans('lang.logout') }}</a></li>
...
<script type="text/javascript">
    ...
    cashbackOfferSetting.get().then(async function(settingSnapshots) {
        if (settingSnapshots.data()) {
            ...
            (settingData.isEnable) ? $('.cashback-menu').removeClass('d-none'): $('.cashback-menu').addClass('d-none');
        }
    })
</script>
