 ...
 <script type="text/javascript">
	...
	async function vendorBuildHTML(vendorId){
		...
		vendorRef.get().then( async function(vendorSnapshots){ 
            	...
            	restaurantHTML = '<div class="col-lg-4 mb-3"><div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm grid-card"><div class="list-card-image"><div class="star position-absolute"><span class="badge badge-success"><i class="feather-star"></i> 3.1 (300+)</span></div><div class="favourite-heart text-danger position-absolute"><a href="#"><i class="feather-heart"></i></a></div><div class="member-plan position-absolute"><span class="badge badge-dark">Promocionado</span></div><a href="restaurant.html"><img onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" alt="#" src="'+vendor.photo+'" class="img-fluid item-img w-100"></a></div><div class="p-3 position-relative"><div class="list-card-body"><h6 class="mb-1"><a href="restaurant.html" class="text-black">'+vendor.title+'</a></h6><p class="text-gray mb-3">Norte • Hamburguesas • Vegetariano</p><p class="text-gray mb-3 time"><span class="bg-light text-dark rounded-sm pl-2 pb-1 pt-1 pr-2"><i class="feather-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $500 PARA DOS</span></p></div><div class="list-card-badge"><span class="badge badge-danger">OFERTA</span> <small>65% siddhi50</small></div></div></div></div></div>';
			}) 
