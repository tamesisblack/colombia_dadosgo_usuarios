    ...
    <div class="card shadow mtn-top-margin">
        ...
        <div class="card-body">
            ...
            <div id="step1" class="step">
                ...
                <form id="mtnForm" method="POST" action="{{ route('giftcard.mtnmomo.request') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('customize.giftcard') }}" class="btn btn-secondary">{{trans('lang.back')}}</a>
            ...
            <div id="step2" class="step d-none text-center mt-5">
                ...
                <p>{{trans('lang.please_approve_payment')}} <strong>{{ $formatted_price }}</strong></p>
                <div class="my-4">
...
<script>
    $(document).ready(function() {
        ...
        $('#mtnForm').submit(function(e) {
            ...
            $.ajax({
                url: '{{ route("giftcard.mtnmomo.request") }}',
                method: 'POST',
                data: JSON.stringify({
                    phone: phone,
        ...
        function startPolling(reference) {
            ...
            pollTimer = setInterval(function() {
                ...
                $.ajax({
                    url: '{{ route("giftcard.mtnmomo.check") }}',
                    method: 'POST',
                    data: JSON.stringify({
                        reference: reference,
                    ...
                    success: function(resp) {
                        if (resp.success === true) {
                            ...
                            setTimeout(() => {
                                window.location.href = resp.redirect || '{{ route("giftcard.success") }}';
                            }, 2000);
