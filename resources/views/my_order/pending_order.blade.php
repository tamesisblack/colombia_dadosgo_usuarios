                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="p-3 border-bottom order_tax_div">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <h6 class="font-weight-bold mb-1">{{ trans('lang.total_tax') }}</h6>
            ...
            if (orderDetails.author.id != user_uuid) {
                ...
                if (orderDetails.hasOwnProperty('takeAway') && orderDetails.takeAway == true) {
                   ...
                   console.log(orderDetails);
                    ...
                    if (orderDetails.driver.profilePictureURL === null) {
                ...
                if (orderDetails.hasOwnProperty('cashback') && orderDetails.cashback != null && orderDetails.cashback != '') {
                    ...
                    $('.cashback-offer').html("🎉 {{trans('lang.you_will_get')}}"+" "+order_cashback+" "+"{{trans('lang.cashback_after_completing_the_order')}}");
                }
            }
